...
public class LocationComponentCameraOptionsActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                LocationComponentCameraOptionsActivity.this.setModeButtonListeners();

                // Retrieve and customize the Maps SDK's LocationComponent
                locationComponent = mapboxMap.getLocationComponent();
                locationComponent.activateLocationComponent(
                        LocationComponentActivationOptions
                                .builder(LocationComponentCameraOptionsActivity.this, style)
                ...
                locationComponent.addOnLocationClickListener(LocationComponentCameraOptionsActivity.this);
                locationComponent.addOnCameraTrackingChangedListener(LocationComponentCameraOptionsActivity.this);
                locationComponent.setCameraMode(cameraMode);
                LocationComponentCameraOptionsActivity.this.setRendererMode(renderMode);
    ...
    private void showModeListDialog() {
        ...
        listPopup.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View itemView, int position, long id) {
                ...
                if (selectedMode.contentEquals(LocationComponentCameraOptionsActivity.this.getString(R.string.normal))) {
                    LocationComponentCameraOptionsActivity.this.setRendererMode(RenderMode.NORMAL);
                } else if (selectedMode.contentEquals(LocationComponentCameraOptionsActivity.this.getString(R.string.compass))) {
                    LocationComponentCameraOptionsActivity.this.setRendererMode(RenderMode.COMPASS);
                } else if (selectedMode.contentEquals(LocationComponentCameraOptionsActivity.this.getString(R.string.gps))) {
                    LocationComponentCameraOptionsActivity.this.setRendererMode(RenderMode.GPS);
                }
                listPopup.dismiss();
            }
        });
    ...
    private void showTrackingListDialog() {
        final List<String> trackingTypes = new ArrayList<>();
        ...
        listPopup.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View itemView, int position, long id) {
                ...
                if (selectedTrackingType.contentEquals(LocationComponentCameraOptionsActivity.this.getString(R.string.none))) {
                    LocationComponentCameraOptionsActivity.this.setCameraTrackingMode(CameraMode.NONE);
                } else if (selectedTrackingType.contentEquals(LocationComponentCameraOptionsActivity.this.getString(R.string.none_compass))) {
                    LocationComponentCameraOptionsActivity.this.setCameraTrackingMode(CameraMode.NONE_COMPASS);
                } else if (selectedTrackingType.contentEquals(LocationComponentCameraOptionsActivity.this.getString(R.string.none_gps))) {
                    LocationComponentCameraOptionsActivity.this.setCameraTrackingMode(CameraMode.NONE_GPS);
                } else if (selectedTrackingType.contentEquals(LocationComponentCameraOptionsActivity.this.getString(R.string.tracking))) {
                    LocationComponentCameraOptionsActivity.this.setCameraTrackingMode(CameraMode.TRACKING);
                } else if (selectedTrackingType.contentEquals(LocationComponentCameraOptionsActivity.this.getString(R.string.tracking_compass))) {
                    LocationComponentCameraOptionsActivity.this.setCameraTrackingMode(CameraMode.TRACKING_COMPASS);
                } else if (selectedTrackingType.contentEquals(LocationComponentCameraOptionsActivity.this.getString(R.string.tracking_gps))) {
                    LocationComponentCameraOptionsActivity.this.setCameraTrackingMode(CameraMode.TRACKING_GPS);
                } else if (selectedTrackingType.contentEquals(LocationComponentCameraOptionsActivity.this.getString(R.string.tracking_gps_north))) {
                    LocationComponentCameraOptionsActivity.this.setCameraTrackingMode(CameraMode.TRACKING_GPS_NORTH);
                }
                listPopup.dismiss();
            }
        });
    ...
    private void setCameraTrackingMode(@CameraMode.Mode final int mode) {
    ...
    private void setModeButtonListeners() {
        ...
        locationModeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LocationComponentCameraOptionsActivity.this.showModeListDialog();
            }
        });
        ...
        locationTrackingBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LocationComponentCameraOptionsActivity.this.showTrackingListDialog();
            }
        });
    }
